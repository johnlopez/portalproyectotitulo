...
class Resultados extends CI_Controller {
    ...
    public function validar_autor() {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $prueba = $this->session->set_userdata('buscar_autor', $buscador);
            redirect(base_url().'resultados/'.$prueba, 'refresh');
        } else {
    ...
    function index($prueba = null) {
        ...
        if($files){
            ...
            if($this->input->post('comprobar')=='1')
            {
